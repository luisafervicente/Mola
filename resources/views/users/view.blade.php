            ...
            <div class="card-body">
                ...
                <div class="form-group " >
                    ...
                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        ...
                        {{Form::text("name",$user->name, array('readonly'),['class'=>'form-control'])}}
                    </div>
                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        {{ Form:: label('apellidos', 'Apellidos: '  ) }}
                        {{ Form:: text('apellidos', $user->apellidos ,array('readonly'),['class'=>'form-control']) }}
                    </div>
                    ...
                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        ...
                        {{ Form:: text('email',  $user->email ,array('readonly'),['class'=>'form-control']) }}
                    </div>

                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        {{ Form:: label('telefono', 'Teléfono: '  ) }}
                        {{ Form:: text('telefono',  $user->telefono ,array('readonly'),['class'=>'form-control']) }} 
                    </div>

                    @foreach($lista_direcciones as $direccion)
                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        {{ Form:: label('calle', 'Calle, número y piso: '  ) }}
                        {{ Form:: text('calle',  $direccion->calle ,array('readonly'),['class'=>'form-control']) }} 
                    </div>

                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        {{ Form:: label('CP', 'CP: '  ) }}
                        {{ Form:: text('codigo_postal', $direccion->codigo_postal ,array('readonly'),['class'=>'form-control']) }} 
                    </div>

                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        {{ Form:: label('poblacion', 'Población: '  ) }}
                        {{ Form:: text('poblacion',   $direccion->poblacion ,array('readonly'),['class'=>'form-control']) }} 
                    </div>

                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        {{ Form:: label('provincia', 'Provincia: '  ) }}
                        {{ Form:: text('provincia',  $direccion->provincia ,array('readonly'),['class'=>'form-control']) }} 
                    </div>

                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        {{ Form:: label('pais', 'Pais: '  ) }}
                        {{ Form:: text('pais',  $direccion->pais ,array('readonly'),['class'=>'form-control']) }} 
                    </div>
                ...
                <div class="form-group " >
                    ...
                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        ...
                        {{ Form:: text('n_tarjeta',  $cliente->n_tarjeta ??'' ,array('readonly'),['class'=>'form-control']) }} 
                    </div>
                ...
                <div class="form-group " >
                    <div class='form-group col-lg-5 col-md-6 col-sm-12 col-12'>
                        ...
                        {{ Form:: text('id',  $administrador->id ,array('readonly')) }} 
                    </div>
