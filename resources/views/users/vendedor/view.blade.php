...
{!! Form::open(['route' =>['vendedor.update',$vendedor  ]]) !!}
@csrf


<div class="form-group col-lg-6 col-md-6 col-sm-12 col-12" >
    <h3>Datos del otro</h3>


    {{ Form:: label('name', 'Nombre: '  ) }}
    {{Form::text("name",   Auth::user()->name ,array('readonly') )}}
    ...
    <a class="btn btn-primary"   href="{{ route('vendedor.edit',$cliente->id) }}">Editar</a>
